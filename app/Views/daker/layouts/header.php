            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="<?= base_url()?>index.html" class="nav-item nav-link active">Inicio</a>
                        <a href="<?= base_url()?>about.html" class="nav-item nav-link">Acerca de nosotros</a>
                        <a href="<?= base_url()?>service.html" class="nav-item nav-link">Servicios</a>
                        <a href="<?= base_url()?>project.html" class="nav-item nav-link">Proyectos</a>
